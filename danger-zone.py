...
if email:
    ...
    if len(domains_from_email) > 0:
        ...
        answer1 = input("Do you want to check domains? [y/n] ")
        if answer1 == "y":
    ...
    if len(ip_help) > 0:
        ...
        answer2 = input("Do you want to check IP(s)? [y/n] ")
        if answer2 == "y":
            for k_ip in ip_help:
                tools.finding(k_ip)
    ...
    if len(domain_from_ip) > 0:
        answer3 = input("Do you want to check domain(s)? [y/n] ")
        if answer3 == "y":
    ...
    if len(emails_help) > 0:
        ...
        answer4 = input("Do you want to check email(s) [y/n] ")
        if answer4 == 'y':
